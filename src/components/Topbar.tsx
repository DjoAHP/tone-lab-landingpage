  ...
  return (
    <nav className="sticky top-0 z-50 animate-slideDown"
         style={{
           ...
           borderBottom: '1px solid rgba(132, 118, 46, 0.3)',
         }}>
      <div className="max-w-[1500px] mx-auto px-10 py-4 flex items-center justify-between">
        ...
        <a
          ...
          style={{
            ...
            boxShadow: '0 4px 15px rgba(132, 118, 46, 0.3)',
            transition: 'all 200ms ease-out',
          }}
          onMouseEnter={(e) => {
            e.currentTarget.style.transform = 'scale(1.05)';
            e.currentTarget.style.boxShadow = '0 8px 25px rgba(132, 118, 46, 0.5)';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.transform = 'scale(1)';
            e.currentTarget.style.boxShadow = '0 4px 15px rgba(132, 118, 46, 0.3)';
          }}
        >
          Télécharger
        </a>
