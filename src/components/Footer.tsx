  ...
  return (
    <footer className="relative overflow-hidden"
            style={{
              ...
              borderTop: '1px solid rgba(132, 118, 46, 0.3)',
            }}>
      {/* Radial gradient overlay */}
      <div className="absolute inset-0 pointer-events-none"
           style={{
             background: `radial-gradient(circle at 50% 100%, rgba(132, 118, 46, 0.08) 0%, transparent 50%)`,
           }} />
          ...
          <div className="flex-1 min-w-[250px]">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-text-muted text-xs">v2.4.4</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-16 flex-wrap">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="https://github.com/DjoAHP/tone-lab-electron/releases/download/v2.4.4/ToneLab-2.4.4.Setup.exe" download="ToneLab-2.4.4.Setup.exe"
