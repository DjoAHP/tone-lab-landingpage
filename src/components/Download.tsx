...
const cardStyle: React.CSSProperties = {
  ...
  boxShadow: '0 20px 60px rgba(0, 0, 0, 0.4), 0 0 80px rgba(42, 61, 92, 0.1)',
  transition: 'all 200ms ease-out',
};

const iconContainerStyle: React.CSSProperties = {
  background: 'linear-gradient(135deg, #2A3D5C, #3A5478)',
  boxShadow: '0 10px 30px rgba(42, 61, 92, 0.4)',
};
  ...
  return (
    <section className="relative overflow-hidden" style={sectionStyle}>
      ...
      <div className="absolute inset-0 pointer-events-none"
           style={{
             background: `
               radial-gradient(circle at 30% 70%, rgba(42, 61, 92, 0.1) 0%, transparent 50%),
               radial-gradient(circle at 70% 30%, rgba(42, 61, 92, 0.08) 0%, transparent 50%)
             `,
           }} />
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto">
        ...
        <div className="max-w-[600px] mx-auto rounded-2xl p-[52px]"
             ...
             onMouseEnter={(e) => {
               ...
               e.currentTarget.style.boxShadow = '0 30px 80px rgba(0, 0, 0, 0.5), 0 0 100px rgba(42, 61, 92, 0.15)';
               e.currentTarget.style.borderColor = 'rgba(42, 61, 92, 0.6)';
             }}
             onMouseLeave={(e) => {
               e.currentTarget.style.transform = 'translateY(0)';
               e.currentTarget.style.boxShadow = '0 20px 60px rgba(0, 0, 0, 0.4), 0 0 80px rgba(42, 61, 92, 0.1)';
               e.currentTarget.style.borderColor = 'rgba(42, 61, 92, 0.3)';
             }}
        >
          {/* Download icon */}
          ...
          <a
            ...
            aria-label="Télécharger ToneLab v2.3.4 pour Windows (132 MB, compatible 10/11 64-bit)"
            ...
            onMouseLeave={(e) => {
              ...
              e.currentTarget.style.boxShadow = '0 10px 30px rgba(42, 61, 92, 0.4)';
            }}
          >
          ...
          <div className="text-text-secondary text-sm mb-8 leading-relaxed">
            <strong className="text-text-primary">Version 2.3.4</strong> • 132 MB<br />
          ...
          <button
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow = '0 10px 30px rgba(42, 61, 92, 0.3)';
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.transform = 'scale(1)';
